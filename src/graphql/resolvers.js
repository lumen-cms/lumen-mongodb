...
module.exports = {
    Query: Object.assign(user.Query, auth.Query, article.Query, files.Query),
    Mutation: Object.assign(user.Mutation, auth.Mutation, article.Mutation, content.Mutation, files.Mutation, fileReference.Mutation),
